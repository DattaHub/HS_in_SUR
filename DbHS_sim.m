...
%     }
    ...
    csvwrite(strcat('\HSGHS\data\DbHS_',name0,'_B.csv'),B)  % change to appropriate folder 
    csvwrite(strcat('\HSGHS\data\DbHS_',name0,'_Omega.csv'),Omega_true)
    % Generate X & Y 
    ...
    %save data
    csvwrite(strcat('\HSGHS\data\DbHS_',name,'_X.csv'),X) % change to appropriate folder 
    csvwrite(strcat('\HSGHS\data\DbHS_',name,'_Y.csv'),Y)
    ...
    csvwrite(strcat('\HSGHS\data\DbHS_',name,'_Xtest.csv'),test_X) % change to appropriate folder 
    csvwrite(strcat('\HSGHS\data\DbHS_',name,'_Ytest.csv'),test_Y)
